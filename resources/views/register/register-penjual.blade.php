...
<div class="w-full max-w-sm p-4 mx-auto mt-[10vh] bg-white border border-gray-200 rounded-xl shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form class="space-y-6" action="/register-penjual" method="post">
        ...
        <div class="flex justify-between">
            <a href="/login-penjual" class="text-xl font-medium text-gray-400 dark:text-white ms-12">Login</a>
            <a href="/register-penjual" class="text-xl font-medium text-blue1 dark:text-white mr-12">Register</a>
        </div>
        ...
        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
            <a href="#" class="text-blue-700 hover:underline dark:text-blue-500">Register Pembeli?</a>
        </div>
    </form>
</div>
