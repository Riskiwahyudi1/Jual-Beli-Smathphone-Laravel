    ...
    <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 mb-3 hide-margin"
        ...
        <div class="row">
            <div class="container-fluid col-md-4 ml-3 ">
                <img src="file/foto barang/<?php echo $foto_barang; ?>"
                    class=" col-xl-10 col-lg-112 col-sm-12 col-12 mb-3 " alt="...">
                ...
                <div class="card mb-1">
                    <div class="card-body bg-light">
                        <form action="" method="post">
                            <b class="card-text jarak-botton" id="nama_barang"><?php echo $nama_barang; ?></b>
                            ...
                            <div class="countainer m-0 p-0">
                                <small class="card-text mt-1 text-warning mt-3">Rp. <span
                                        id="harga_barang"><?php echo $harga; ?></span></small><br>
                                <input type="hidden" name="harga" id="hiddenInputBarang" value="">
                                <small class="card-text mt-2"><b>Tersedia :</b> <?php echo $stok_barang ?></small>
                                <div class="countainer-fluid col mt-2">
                            ...
                            <div class="col mb-4 mt-3">
                                <div class="d-flex align-items-center">
                                    <img src="file/foto profil user/market.jpg"
                                        class="card-img-top border border-dark border-2" alt="..."
                                        style="width: 6%; border-radius :50%;">
                                    <b class="ms-3"><?php echo $penjual; ?></b>
                                </div>
                            ...
                            <div>
                                <button type="button" class="btn btn-primary btn-lg mb-2">
                                    <a id="linkId" href="checkout_now.php?id_barang=<?php echo $id_barang; ?>"
                                        class="text-white text-decoration-none">Checkout</a>
                                </button>
                                <button type="submit" name="keranjang" class="btn btn-primary btn-lg mb-2">
