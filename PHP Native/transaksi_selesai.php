...
<body>
    ...
    <div class="col-md-2 pr-3 pt-4 d-none d-md-block"
            ...
            <ul class="nav flex-column ml-3 mb-5 ">
                ...
                <li class="nav-item ">
                    <a class="nav-link text-dark click-transaksi-menu bg-white rounded mb-2"><i class="fas fa-dollar me-2"></i>Data
                        Transaksi</a>
                    <div>
                        <a class="nav-link text-white ms-4 hide-transaksi-menu text-dark rounded"  href="data_transaksi.php">Menunggu
                            Konfirmasi</a>
                        <a class="nav-link text-white ms-4 hide-transaksi-menu"  href="data_pengiriman.php">Proses
                            Pengiriman</a>
                        <a class="nav-link text-white ms-4 hide-transaksi-menu" style="background-color: #8CADCE;" href="transaksi_selesai.php">Transaksi
                            Selesai</a>
                        <a class="nav-link text-white ms-4 hide-transaksi-menu"  href="transaksi_dibatalkan.php">Transaksi
                            Dibatalkan</a>
                    </div>
                    <hr class="bg-secondary ">
        ...
        <div class="col-md-10 p-5 pt-2" style="margin-left: 250px;">
            <center>
                <h4><i class="fas mt-5"></i> Data Transaksi Selesai</h4>
            ...
            <hr>
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM data_transaksi WHERE nama_penjual ='$username' AND status_transaksi = 'selesai'");
              $no = 1;
                ...
                <div class="container-fluid col-md-12 " style=" padding:25vh 20px 10vh 20px;">
                    <div>
                        <div class="d-flex justify-content-center mt-2">
                            <h5>Belum ada transaksi dengan status selesai</h5>
                        </div>
                        <div class="d-flex justify-content-center mt-2">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="delete.php?id_transaksi=<?php echo $data['id_transaksi']; ?>"
