...
$result = mysqli_query($koneksi, "SELECT * FROM keranjang WHERE id_barang='$id_barang'");
            ...
            <div class="container-fluid" style="margin-top:50px; ">
                ...
                <div class="row">
                    <div class="col-md-3 mt-1 mb-3 me-1">
                        <b>Penjual : <span id="getNamaPenjual"> <?php echo $data['username_penjual'];?></span></b>
                    </div>
                </div>
                <div class="row">
                ...
                <div class=" row" style="border-bottom: solid 1px black;">
                    ...
                    <div class="col-md-3 ">
                        <p style="color: #FF7F09;">Rp.<span class="harga" data-harga="10"
                                id="getHargaBarang"><?php echo $data['harga_barang'];?></span></p>
                    </div>
                </div>
                <div class="row">
              ...
              ?>
                <div class=" row" style="border-bottom: solid 1px black;">
                    <div class="col-md-4 me-5" style="margin-left:50px;">
                        <p id="getAlamat"><?php echo $dataAlamat['nama_pengguna'];?> |
                            <?php echo $dataAlamat['no_hp'];?> | <?php echo $dataAlamat['alamat'];?></p>
                    </div>
                    <div class=" col-md-2 ">
                        <a href="data_akun.php" class="text-decoration-none " style="color:#FF7F09;">Ubah Alamat</a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-11 mt-3 mb-3 d-flex justify-content-end " style="color:#FF7F09;">
                        <p class="me-5" id="gettotalTransaksi">Rp.<span
                                class="total"><?php echo $data['harga_barang'];?></span></p>
                        ...
                        <input type="hidden" name="nama_penjual" id="nama_penjual"
                            value="<?php echo $data['username_penjual'];?>">
