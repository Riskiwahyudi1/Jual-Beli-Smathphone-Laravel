...
<body>
    <div class="card-body col-xl-4 col-lg-4 col-md-6 col-sm-6 col-8 mx-auto "
        ...
        <center>
            <h5 class="text-primary mt-5" style="padding-top: 2rem ;">Register Penjual</h5>
        </center>
        <form action="" method="POST">
            ...
            <div class="col-8 col-xl-6 mx-auto mb-3">
                <div class="input-group">
                    <input type="password" class="form-control hide-password" name="konfirmasi_kata_sandi"
                        id="kata-sandi" placeholder="Konfirmasi Password" required>
                    <div class="input-group-append ">
                        <span class="input-group-text">
                            <i class="fa-solid fa-eye-slash"></i>
                        </span>
            ...
            <center style="padding-bottom: 2rem; margin :auto;">
                <small class="pull-right pb-5">Sudah Daftar? <a href="login_penjual.php">Masuk</a></small>
            </center>
        </form>
    </div>
    ...
    if (isset($_POST['daftar'])) {
        ...
        if ($kata_sandi != $konfirmasi_kata_sandi) {
            ...
            $query = "INSERT INTO login_penjual (username, email, no_hp, kata_sandi) VALUES ('$username', '$email', '$no_hp', '$hashed_password')";
            ...
            if ($result) {
                ...
                echo 'window.location.href ="login_penjual.php";'; 
                echo '</script>';
            } else {
