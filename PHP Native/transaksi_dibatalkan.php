...
<body>
    ...
    <div class="col-md-2 pr-3 pt-4 d-none d-md-block"
                ...
                <li class="nav-item ">
                    ...
                    <div>
                        ...
                        <a class="nav-link text-white ms-4 hide-transaksi-menu"  href="transaksi_selesai.php">Transaksi
                            Selesai</a>
                        <a class="nav-link text-white ms-4 hide-transaksi-menu" style="background-color: #8CADCE;" href="transaksi_dibatalkan.php">Transaksi
                            Dibatalkan</a>
                    </div>
                    <hr class="bg-secondary ">
        ...
        <div class="col-md-10 p-5 pt-2" style="margin-left: 250px;">
            <center>
                <h4><i class="fas mt-5"></i> Data Transaksi Dibatalkan</h4>
            ...
            <hr>
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM data_transaksi WHERE nama_penjual ='$username' AND status_transaksi = 'Dibatalkan'");
              $no = 1;
                ...
                <div class="container-fluid col-md-12 " style=" padding:25vh 20px 10vh 20px;">
                    <div>
                        <div class="d-flex justify-content-center mt-2">
                            <h5>Tidak ada pesanan pembelian yang anda batalkan !!</h5>
                        </div>
