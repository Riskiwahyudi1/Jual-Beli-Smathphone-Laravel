...
<?php
    ...
    if (isset($_POST['login'])) {
        ...
        $data = mysqli_query($koneksi, "SELECT * FROM login_pembeli WHERE username='$username'");
    ...
    <div class="card-body col-xl-4 col-lg-4 col-md-6 col-sm-6 col-8 mx-auto " style="background-color: #FAF6F6; margin-top : 20vh; border-radius:20px; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.2);">
        <center>
        <center>
            <h5 class="text-primary mb-3" style="padding-top: 2rem ;">Login Pembeli</h5>
        </center>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <center style="padding-bottom: 2rem; margin :auto;">
                <small class="pull-right"> Belum Punya Akun? <a href="register.php">Daftar</a></small><br>
                <small class="pull-right pb-5 ">Anda Punya Toko ? <a href="login_penjual.php" class="text-danger fw-bold">Login Penjual</a></small>
            </center>
        </form>
    </div>
    <script>
