        ...
        <form action="konfirmasi-checkout" method="post">
            ...
            <div class="grid my-2 md:grid-cols-2">
                <div >
                    ...
                    <input type="text" name="nama-depan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-5/6 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Nama Depan Anda" required />
                </div>
                <div>
