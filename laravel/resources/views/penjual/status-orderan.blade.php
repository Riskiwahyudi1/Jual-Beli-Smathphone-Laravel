...
<div class="pt-10 ps-40">
    ...
    <p class="ms-6 mt-12 text-2xl font-bold text-black">Status Orderan</p>
    ...
    <tbody>
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4">   
            <button type="button" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300  rounded-full text-xl px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900 font-extrabold">!</button>
