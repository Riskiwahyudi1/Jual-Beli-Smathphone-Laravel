...
<div class="pt-10 ps-40">
    ...
    <p class="ms-6 mt-12 text-4xl font-bold text-black">Status Orderan</p>
    ...
    <button type="submit" style="height: 25px;"
        ...
        <p class="ms-6 mt-12 text-2xl font-bold text-black">Daftar Transaksi</p>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr
                    ...
                    <td class="px-7 py-4">
                        <button type="button"
                            class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300  rounded-full text-md px-3.5  py-1.5 me-2 mb-2 dark:focus:ring-yellow-900 font-bold">!</button>
