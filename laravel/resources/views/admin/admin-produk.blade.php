...
<div class="pt-10 ps-40">
    ...
    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white bg-blue2 hover:bg-blue1 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center " type="button">Status Produk<svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    <button data-modal-target="verifikasi-modal{{ $produk->id }}" data-modal-toggle="verifikasi-modal{{ $produk->id }}" type="button"
                        ...
                        <button data-modal-target="tolak-modal{{ $produk->id }}" data-modal-toggle="tolak-modal{{ $produk->id }}" type="button"
                            ...
                            <a href="/admin-detail-produk/{{ $produk->id}}"
                                ...
                                <button data-modal-target="tolak-modal{{ $produk->id }}" data-modal-toggle="tolak-modal{{ $produk->id }}" type="button"
                                    class="focus:outline-none text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 rounded-md text-xs px-2 py-1 me-2 mb-2 dark:focus:ring-red-900 font-bold">Tangguhkan</button>  
                                    <a href="/admin-detail-produk/{{ $produk->id}}"
                                        class="focus:outline-none text-white bg-yellow-500 hover:bg-yellow-700 focus:ring-4 focus:ring-blue-300 rounded-md text-xs px-2 py-1 me-2 mb-2 dark:focus:ring-blue-900 font-bold">Detail</a>
                                        @elseif ($produk->status == 'pengajuan-ditolak')
                                        <button data-modal-target="verifikasi-modal{{ $produk->id }}" data-modal-toggle="verifikasi-modal{{ $produk->id }}" type="button"
                                            class="focus:outline-none text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 rounded-md text-xs px-2 py-1 me-2 mb-2 dark:focus:ring-blue-900 font-bold">Pulihkan</button>
                                        <a href="/admin-detail-produk/{{ $produk->id}}"
                                            class="focus:outline-none text-white bg-yellow-500 hover:bg-yellow-700 focus:ring-4 focus:ring-blue-300 rounded-md text-xs px-2 py-1 me-2 mb-2 dark:focus:ring-blue-900 font-bold">Detail</a>
                                            @endif
                                        </td>
