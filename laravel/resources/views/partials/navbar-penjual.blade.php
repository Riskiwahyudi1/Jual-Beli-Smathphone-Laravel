...
<nav class="w-[10vw] bg-gray-200 h-[100vh] fixed mt-12 z-10">
    ...
    <a href="/produk-penjual">
        <button class="px-4 py-2 ms-4 {{ $active === "produk-penjual" || $active === "tambah-produk-penjual" ? '  bg-blue2 text-white': '' }} mt-2 rounded-md font-semibold"><i class="fas fa-box mr-2"></i>Produk</button>
    </a>
